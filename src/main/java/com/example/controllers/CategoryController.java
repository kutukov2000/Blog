...
public class CategoryController {
    ...
    public ResponseEntity<CategoryItemDTO> getById(@PathVariable int id) {
        ...
        CategoryItemDTO postItemDTO = categoryMapper.categoryItemDTO(category);
    ...
    @PutMapping()
    public ResponseEntity<CategoryItemDTO> edit(@RequestBody CategoryEditDTO updatedCategoryDTO) {
